"""
Notes:
    Based on template code in: ~/code/torch_liberator/docs/source/conf.py

    http://docs.readthedocs.io/en/latest/getting_started.html

    pip install sphinx sphinx-autobuild sphinx_rtd_theme sphinxcontrib-napoleon

    cd ~/code/torch_liberator
    mkdir -p docs
    cd docs
    ...
    cd ~/code/torch_liberator/docs
    sphinx-apidoc -f -o ~/code/torch_liberator/docs/source ~/code/torch_liberator/torch_liberator --separate
    make html
    ...
    Also:
        ...
        https://readthedocs.org/dashboard/torch_liberator/advanced/
        ...
        Will also need to activate the main branch:
            https://readthedocs.org/projects/torch_liberator/versions/
"""
#
...
# html_logo = '.static/torch_liberator.svg'
# html_favicon = '.static/torch_liberator.ico'
...
htmlhelp_basename = 'torch_liberatordoc'
...
latex_documents = [
    (master_doc, 'torch_liberator.tex', 'torch_liberator Documentation',
     'Jon Crall', 'manual'),
]
...
man_pages = [
    (master_doc, 'torch_liberator', 'torch_liberator Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'torch_liberator', 'torch_liberator Documentation',
     author, 'torch_liberator', 'One line description of project.',
     'Miscellaneous'),
]
