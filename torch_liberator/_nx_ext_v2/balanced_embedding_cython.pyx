...
xdoctest -m torch_liberator._nx_ext_v2.balanced_embedding_cython list
python -m xdoctest torch_liberator._nx_ext_v2.balanced_embedding_cython __doc__:0 --bench


Example
-------
>>> from torch_liberator._nx_ext_v2.balanced_embedding_cython import _lcse_iter_cython, IdentityDictCython
>>> from torch_liberator._nx_ext_v2.balanced_sequence import random_balanced_sequence
>>> from torch_liberator._nx_ext_v2.balanced_embedding import _lcse_iter
>>> import operator
...
>>> from torch_liberator._nx_ext_v2 import balanced_embedding as bemb
>>> seq_len = 200
